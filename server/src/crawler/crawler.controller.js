...
var CrawlerController = /** @class */ (function () {
    function CrawlerController(crawlerService) {
        this.crawlerService = crawlerService;
    }
    CrawlerController.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.crawlerService.craw()];
            });
        });
    };
    __decorate([
        (0, common_1.Get)()
    ], CrawlerController.prototype, "get");
